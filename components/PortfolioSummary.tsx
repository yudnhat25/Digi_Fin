...
const PortfolioSummary: React.FC<PortfolioSummaryProps> = ({ userState, marketPrices }) => {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      {/* Asset Value Card */}
      <div className="bg-slate-900/50 backdrop-blur border border-slate-800 p-5 rounded-2xl">
        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Asset Value</p>
        <h3 className="text-2xl font-black text-emerald-400">
          ${assetValue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        </h3>
        <p className="text-[10px] text-slate-500 mt-1">Current Holdings</p>
      </div>
